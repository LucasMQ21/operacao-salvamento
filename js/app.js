/* =========================================================
   ...
   ========================================================= */
const SIM_URLS_POR_NIVEL = {"1":["./simulators/simulator-01.html","./simulators/simulator-02.html","./simulators/simulator-05.html",null,null,null,null,null,null,null,null,null,null,null],"2":["./simulators/simulator-03.html","./simulators/simulator-04.html","./simulators/simulator-12.html","./simulators/simulator-06.html","./simulators/simulator-07.html","./simulators/simulator-08.html","./simulators/simulator-09.html","./simulators/simulator-10.html","./simulators/simulator-11.html","./simulators/simulator-13.html","./simulators/simulator-14.html",null,null,null]};
let SIM_URLS = SIM_URLS_POR_NIVEL[2];
const MISSOES_POR_NIVEL = {"1":[{"id":0,"nome":"Viatura na Oficina","titulo":"🚒 Missão 1: Libere a Viatura da Oficina","resolvida":false,"pronta":true,"nivel":"Ensino Fundamental","imagemMapa":"./assets/embedded/2579db1e64e8efaef02a.webp"},{"id":1,"nome":"Gestão da Água","titulo":"🔥 Missão 2: Incêndio em Galpão — Gestão da Água","resolvida":false,"pronta":true,"nivel":"Ensino Fundamental","trilhaSincronizadaSimulacao":true,"trilhaIniciaAoAbrirSimulador":true,"imagemMapa":"./assets/embedded/10a9a10a158d24af7495.webp"},{"id":2,"nome":"Galeria Subterrânea","titulo":"🕳️ Missão 3: Galeria Subterrânea","resolvida":false,"pronta":true,"nivel":"Ensino Fundamental","imagemMapa":"./assets/embedded/4c586e24afa67ddf3eb1.webp"},{"id":3,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":4,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":5,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":6,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":7,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":8,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":9,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":10,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":11,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":12,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null},{"id":13,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Fundamental","imagemMapa":null}],"2":[{"id":0,"nome":"Resgate de Animal","titulo":"🐄 Missão 1: Resgate Animal","resolvida":false,"pronta":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/bad1b1a79a37c2227cd9.webp"},{"id":1,"nome":"Resgate no Rio","titulo":"🌊 Missão 2: Resgate na Água","resolvida":false,"pronta":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/e6c58245349d3386bf84.webp"},{"id":2,"nome":"Parada Cardiorrespiratória","titulo":"❤️ Missão 3: APH — RCP em Shopping Center","resolvida":false,"pronta":true,"trilhaSincronizadaSimulacao":true,"trilhaIniciaAoAbrirSimulador":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/missao03_aph_rcp_shopping_mapa.png"},{"id":3,"nome":"Buscas na Mata","titulo":"🌲 Missão 4: Buscas na Mata","resolvida":false,"pronta":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/dc2c9085cec882ec5853.webp"},{"id":4,"nome":"Combate a Incêndio","titulo":"🔥 Missão 5: Combate ao Incêndio","resolvida":false,"pronta":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/4345553e661a40603378.webp"},{"id":5,"nome":"Busca Aquática","titulo":"💧 Missão 6: Busca Aquática em Cachoeira","resolvida":false,"pronta":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/a9d07d0e506d1490275a.webp"},{"id":6,"nome":"Construção de Aceiro","titulo":"🔥 Missão 7: Incêndio Florestal — Construção de Aceiro","resolvida":false,"pronta":true,"trilhaSincronizadaSimulacao":true,"trilhaIniciaAoAbrirSimulador":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/45bbddf39c66f6a41757.webp"},{"id":7,"nome":"Autonomia de Ar","titulo":"🫁 Missão 8: Autonomia de Ar — Busca em Apartamento","resolvida":false,"pronta":true,"trilhaSincronizadaSimulacao":true,"trilhaIniciaAoAbrirSimulador":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/edadc334ea385b7ea95a.webp"},{"id":8,"nome":"Travessia Estratégica","titulo":"🚤 Missão 9: Travessia Estratégica na Represa","resolvida":false,"pronta":true,"trilhaSincronizadaSimulacao":true,"trilhaIniciaAoAbrirSimulador":true,"fluxoOcorrencia":"pedido-presencial","nivel":"Ensino Médio","imagemMapa":"./assets/embedded/ee772d39e85b47140d05.png"},{"id":9,"nome":"Posicionamento da Plataforma","titulo":"🚒 Missão 10: Posicionamento da Plataforma e Projeção do Jato","resolvida":false,"pronta":true,"trilhaSincronizadaSimulacao":true,"trilhaIniciaAoAbrirSimulador":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/missao10_posicionamento_plataforma_mapa.png"},{"id":10,"nome":"Pressão no esguicho","titulo":"🔥 Missão 11: Pressão no esguicho","resolvida":false,"pronta":true,"trilhaSincronizadaSimulacao":true,"trilhaIniciaAoAbrirSimulador":true,"nivel":"Ensino Médio","imagemMapa":"./assets/embedded/missao11_pressao_esguicho_mapa.png"},{"id":11,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Médio","imagemMapa":null},{"id":12,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Médio","imagemMapa":null},{"id":13,"nome":"Em breve","titulo":"","resolvida":false,"pronta":false,"nivel":"Ensino Médio","imagemMapa":null}]};
const BRIEFINGS_POR_NIVEL = {"1":[{"titulo":"🚒 Missão 1: Libere a Viatura da Oficina","contexto":"Durante seu turno de serviço, você recebeu de seu comandante a missão de buscar uma viatura no pátio da oficina do Centro de Suprimentos e Manutenção. O tenente, chefe da Seção de Transportes, informou que o conserto já foi finalizado e que a viatura está pronta para retornar ao serviço. Ao chegar ao local, porém, você percebe que outras viaturas foram estacionadas ao redor dela, bloqueando o caminho até a saída. Como bombeiro motorista em diligência, caberá a você reorganizar o pátio e liberar a viatura que ficou pronta. O espaço disponível é reduzido e exige cuidado durante as manobras. Para evitar colisões e facilitar a movimentação em uma área apertada, o chefe da guarnição determinou que cada viatura seja movimentada apenas para frente ou para trás, de acordo com a posição em que se encontra.","objetivo":"Planejar uma sequência de deslocamentos, reorganizar as demais viaturas e conduzir a viatura 1 até a saída do pátio com segurança.","dados":["A viatura que deverá sair do pátio é a <strong>viatura 1</strong>.","O pátio está representado por uma malha de <strong>6 × 6 casas</strong>.","Cada viatura pode se mover somente no sentido em que está posicionada.","Viaturas horizontais movem para a esquerda ou para a direita; viaturas verticais movem para cima ou para baixo.","Nenhuma viatura pode atravessar outra nem ultrapassar os limites do pátio.","Cada casa da malha representa uma posição possível de estacionamento e manobra.","A missão será concluída quando a viatura 1 alcançar a saída."],"modelo":"Observe a posição ocupada por cada viatura na <strong>malha quadriculada</strong>. Antes de deslocar uma viatura, antecipe quais casas serão liberadas e quais continuarão bloqueadas.","tarefa":"Manobre as viaturas na ordem correta e abra um caminho até a saída, retirando a viatura 1 do pátio sem ultrapassar os limites da malha e sem encostar nas demais viaturas.","nota":"A situação foi simplificada para fins didáticos. Em uma manobra real, o motorista deve seguir as normas de segurança, utilizar auxílio de balizadores quando necessário e considerar as características do local e de cada viatura.","icone":"🚒","heroLabel":"Missão 1 · Ensino Fundamental","dicas":["A viatura 1 pode avançar uma casa antes de você reorganizar as demais.","Leve a viatura 5 para o alto do pátio; isso libera a faixa inferior.","Depois, mova a viatura 4 para a esquerda e a viatura 2 para baixo."],"debriefing":{"contextoOperacional":"A missão representou uma diligência de apoio logístico no Centro de Suprimentos e Manutenção. Para retirar uma viatura pronta, foi necessário observar o espaço disponível, antecipar consequências e organizar uma sequência de movimentos sem colisões.","reflexoes":["As atividades do bombeiro militar não se limitam ao atendimento de ocorrências: manutenção, logística e preparação de recursos também são essenciais para a prontidão operacional.","Planejar antes de agir reduz movimentos desnecessários e ajuda a evitar danos às viaturas e ao patrimônio público.","Um único deslocamento pode liberar ou bloquear novas possibilidades, por isso a ordem dos movimentos é importante."],"simplificacoes":["O pátio foi representado por uma malha regular de 6 × 6 casas.","As viaturas foram tratadas como figuras retangulares que ocupam casas inteiras da malha.","Cada viatura pôde se mover somente para frente ou para trás, sem realizar curvas.","Foram desconsiderados largura real, raio de giro, distância de segurança, presença de pessoas e condições do piso."],"matematica":["Localização em malha quadriculada","Orientação espacial e reconhecimento de direções","Organização de sequências","Antecipação de movimentos","Resolução de problemas por planejamento e tentativa"],"interdisciplinaridade":["Matemática e orientação espacial na organização do pátio.","Logística e manutenção na disponibilidade das viaturas.","Educação para o trânsito e segurança durante manobras.","Responsabilidade no cuidado com equipamentos e patrimônio público."],"limitesModelo":["O simulador não reproduz a dinâmica completa de uma manobra veicular real.","O modelo não considera esterçamento, ré com mudança de direção, pontos cegos, dimensões exatas nem comunicação entre motorista e balizador.","A solução do jogo não deve ser interpretada como procedimento técnico de condução ou organização de um pátio real."],"seguranca":["Manobras reais devem ser realizadas somente por condutores habilitados e autorizados.","Em espaços reduzidos, devem ser observados os procedimentos institucionais, a sinalização e o auxílio de balizadores quando aplicável.","Nunca permaneça em pontos cegos ou entre viaturas durante uma manobra."],"reflexaoFinal":"A malha quadriculada permite estudar o planejamento de movimentos de forma simples e visual. Na realidade, uma manobra segura depende de mais fatores, mas a capacidade de observar, antecipar e organizar uma sequência continua sendo fundamental."},"imagem":"./assets/embedded/b7f9f06cbf02361df6ab.webp"},{"titulo":"🔥 Missão 2: Incêndio em Galpão — Gestão da Água","contexto":"Sua equipe chegou a um galpão industrial com um incêndio em desenvolvimento. A viatura disponível possui uma quantidade limitada de água e uma segunda viatura de apoio chegará em 12 minutos. Quatro linhas de mangueira estão disponíveis e podem ser abertas ou fechadas de forma independente. Sua missão é administrar a água da viatura e controlar o incêndio até a chegada do apoio.","objetivo":"Controlar e extinguir o incêndio, manter o rescaldo e fazer a água disponível durar até a chegada da viatura de apoio.","dados":["O galpão possui <strong>120 m²</strong> de área total.","No início da ocorrência, <strong>42 m²</strong> estão em chamas.","A viatura possui um tanque com <strong>4.800 L</strong> de água.","Existem <strong>4 linhas de combate</strong>, que podem ser abertas ou fechadas de forma independente.","Cada linha aberta consome <strong>160 L/min</strong>.","Sem combate, a propagação estimada neste modelo é de <strong>21 m²/min</strong>.","Cada linha aberta reduz a progressão do incêndio em <strong>7 m²/min</strong>.","A viatura de apoio chegará em <strong>12 minutos</strong>.","Depois da extinção, o rescaldo não pode permanecer <strong>20 segundos sem água</strong>, ou haverá reignição."],"modelo":"Antes de iniciar, compare o número de linhas abertas, o consumo total de água, a autonomia do tanque e a evolução da área em chamas. Durante a simulação, o relógio avança em intervalos de 10 segundos simulados. Use o botão <strong>Pausar</strong> quando chegar ao instante em que deseja alterar sua estratégia.","tarefa":"Defina a configuração inicial das linhas e execute sua estratégia. Abra, feche e reorganize as linhas nos momentos que considerar adequados para extinguir o incêndio, preservar água suficiente para o rescaldo e chegar ao final dos 12 minutos com a ocorrência controlada.","nota":"Os valores de propagação e de redução da área em chamas são parâmetros didáticos deste cenário. Eles foram definidos para a modelagem matemática da missão e não representam regras universais de combate a incêndio.","icone":"🔥","heroLabel":"Missão 2 · Ensino Fundamental","dicas":["Compare o consumo total quando uma, duas, três ou quatro linhas estão abertas. O que acontece com a autonomia do tanque quando o número de linhas aumenta?","Observe a área em chamas. Com quais quantidades de linhas o incêndio cresce, permanece estável ou diminui?","Depois que as chamas forem extintas, o objetivo passa a ser manter o rescaldo sem desperdiçar a água que ainda precisa durar até a chegada do apoio."],"debriefing":{"contextoOperacional":"A missão representou um incêndio em galpão no qual a equipe precisava administrar uma reserva hídrica limitada até a chegada de uma segunda viatura. O desafio foi equilibrar intensidade de combate, consumo de água, autonomia e rescaldo.","reflexoes":["Abrir mais linhas aumenta simultaneamente a capacidade de combate e o consumo de água; por isso, uma decisão favorável em uma grandeza pode produzir uma consequência desfavorável em outra.","Uma linha preserva água, mas não contém a propagação estimada neste modelo; duas linhas ainda permitem crescimento; três linhas estabilizam a área em chamas; quatro linhas fazem a área diminuir.","Depois da extinção das chamas, manter a mesma intensidade de combate pode representar desperdício de água, enquanto interromper completamente o fornecimento por 20 segundos provoca reignição no modelo.","A estratégia precisa considerar não apenas o instante atual, mas também a quantidade de água necessária para chegar ao final dos 12 minutos."],"simplificacoes":["O galpão foi representado por uma área total fixa de 120 m² e o incêndio por uma única medida de área em chamas.","Todas as quatro linhas foram modeladas com a mesma vazão de 160 L/min.","A propagação foi representada por uma taxa constante de 21 m²/min e o efeito de cada linha por 7 m²/min.","O consumo, a evolução do incêndio e a chegada do apoio foram tratados em intervalos discretos de 10 segundos simulados.","O rescaldo foi simplificado por uma regra de reignição após 20 segundos consecutivos sem água."],"matematica":["Proporcionalidade direta entre número de linhas e vazão total: Q(n) = 160 · n L/min.","Proporcionalidade inversa entre número de linhas e autonomia do tanque: A(n) = 4.800 / (160 · n) = 30 / n minutos.","Análise de uma taxa líquida para a evolução do incêndio: R(n) = 21 − 7 · n m²/min.","Interpretação de consumo, tempo, autonomia, crescimento, estabilização e redução.","Planejamento de estratégia a partir da comparação entre grandezas e da experimentação."],"interdisciplinaridade":["Matemática aplicada à administração de recursos durante uma situação operacional simulada.","Relação entre tomada de decisão, disponibilidade de água e evolução de um incêndio representado por um modelo.","Leitura de indicadores visuais de tanque, vazão, tempo e área em chamas."],"limitesModelo":["As taxas de propagação e de redução utilizadas são parâmetros didáticos específicos desta missão.","O simulador não reproduz todas as variáveis físicas, ambientais e operacionais presentes em um incêndio real.","As relações numéricas da missão foram escolhidas para permitir a exploração de proporcionalidade e não devem ser interpretadas como regras universais de combate a incêndio."],"seguranca":["Esta atividade é uma representação educacional e não constitui orientação técnica para atuação em incêndios reais.","Os valores e as decisões apresentados pertencem ao modelo matemático da missão e não substituem procedimentos operacionais, treinamento ou avaliação técnica de uma ocorrência real."],"reflexaoFinal":"Ao experimentar diferentes configurações, é possível perceber que usar mais linhas aumenta o consumo de forma diretamente proporcional e reduz a autonomia do tanque. A missão mostra como uma estratégia pode surgir da análise conjunta dessas grandezas e das consequências observadas na simulação."},"imagem":"./assets/embedded/941b53ec4285d3c4fe79.webp"},{"titulo":"🕳️ Missão 3: Galeria Subterrânea","contexto":"Um cachorro está preso em uma rede subterrânea. Para inspecionar toda a galeria sem repetir trechos, a equipe deve planejar uma rota que percorra cada tubulação exatamente uma vez.","objetivo":"Encontrar, por investigação, uma rota que percorra todas as tubulações exatamente uma vez e depois analisar as diferentes soluções para descobrir um padrão na rede.","dados":["A rede possui 7 poços de acesso, numerados de 1 a 7.","Existem 10 tubulações ligando os poços.","Cada tubulação deve ser percorrida exatamente uma vez.","A rota pode começar e terminar em poços diferentes."],"modelo":"Você receberá a planta da galeria e poderá testar livremente diferentes percursos. <strong>Nenhuma regra matemática sobre a rota será apresentada antes da tentativa.</strong> Depois que uma solução for encontrada, o próprio simulador conduzirá uma investigação sobre as conexões entre os poços e sobre o que as diferentes rotas têm em comum.","tarefa":"Escolha livremente o poço inicial e construa uma rota que utilize todas as 10 tubulações sem repetir nenhuma. Após encontrar uma solução, siga as etapas de investigação apresentadas pelo simulador.","nota":"O desafio começa pela exploração e pela tentativa. A formalização matemática do padrão encontrado será apresentada somente ao final, no debriefing.","icone":"🕳️","heroLabel":"Missão 3 · Ensino Fundamental","dicas":["Se sua rota ficar sem saída antes de usar todas as tubulações, observe em qual poço isso aconteceu e quais ligações já foram utilizadas.","Compare suas tentativas. Mudar o poço inicial ou a ordem das escolhas pode abrir novas possibilidades.","Antes de percorrer uma tubulação, pense se essa escolha pode deixar alguma parte da rede sem possibilidade de acesso depois."],"debriefing":{"contextoOperacional":"A rede subterrânea foi percorrida inicialmente sem uma regra pronta. Depois de encontrar uma solução, a estrutura da rede foi analisada por contagem, comparação de rotas e reconhecimento de padrões.","reflexoes":["A primeira solução foi construída por tentativa, planejamento e análise do mapa, antes da apresentação de qualquer regra formal.","Ao contar as conexões, os poços 1, 6 e 7 possuem 2 tubulações; os poços 2 e 5 possuem 3; e os poços 3 e 4 possuem 4.","Considerando o sentido do percurso, a rede admite 88 sequências válidas, organizadas em 44 pares inversos.","Todas as soluções começam no poço 2 e terminam no poço 5, ou começam no poço 5 e terminam no poço 2.","Os poços 2 e 5 são justamente os únicos que possuem uma quantidade ímpar de tubulações."],"simplificacoes":["Cada poço foi representado por um vértice e cada tubulação por uma aresta.","A rede foi considerada conhecida, conexa e livre para deslocamento.","Foram desprezados comprimentos diferentes, inclinações, bloqueios, água, gases, visibilidade, tempo de acesso e risco de desabamento."],"matematica":["Contagem de conexões em uma rede","Números pares e ímpares","Representação por pontos e ligações","Grau de vértices","Comparação de soluções e reconhecimento de padrões","Caminho euleriano"],"interdisciplinaridade":["Matemática e raciocínio lógico no planejamento de percursos.","Engenharia e Saneamento na compreensão de galerias e tubulações.","Organização espacial e leitura de redes aplicadas a uma situação operacional simulada."],"limitesModelo":["Uma rota matematicamente válida pode ser operacionalmente inviável devido a riscos ou restrições físicas.","A rede real precisaria ser avaliada quanto à atmosfera, estabilidade, acessos, comunicação e possibilidade de retirada."],"seguranca":["Galerias, bueiros e redes subterrâneas são espaços confinados e podem conter gases tóxicos ou deficiência de oxigênio.","Não entre. Isole a área e acione o Corpo de Bombeiros pelo 193."],"reflexaoFinal":"Esse tipo de percurso é conhecido na Matemática como caminho euleriano. Euler percebeu que uma rota que percorre cada ligação exatamente uma vez depende da quantidade de ligações existentes em cada ponto. Nesta rede, os dois poços com número ímpar de tubulações precisam ser as extremidades do percurso: um será o ponto de partida e o outro, o ponto de chegada."},"imagem":"./assets/embedded/f084c6087708006a2ce3.webp"},null,null,null,null,null,null,null,null,null,null,null],"2":[{"titulo":"🐄 Missão 1: Resgate Animal na Cisterna","contexto":"Uma vaca caiu em uma cisterna e precisa ser içada com segurança. A equipe dispõe de dois sistemas de polias e deve escolher aquele que exige a menor força real de tração.","objetivo":"Comparar dois sistemas de polias, calcular a força real necessária e selecionar a configuração mais eficiente para o içamento.","dados":["Peso considerado do animal: P = 5.000 N.","Sistema A: vantagem mecânica VM = 3:1 e n = 2 polias.","Sistema B: vantagem mecânica VM = 5:1 e n = 4 polias.","Para esta simulação, considere acréscimo equivalente a 10% por polia."],"modelo":"Use <code>F<sub>R</sub> = (P ÷ VM) × (1 + 0,10 × n)</code> e compare os resultados dos dois sistemas.","tarefa":"Selecione o sistema que exige menor força e informe, em newtons, a força real de tração correspondente.","nota":"O acréscimo de 10% por polia é uma simplificação didática adotada exclusivamente no modelo desta missão.","icone":"🐄","heroLabel":"Missão 1","dicas":["Calcule primeiro a força ideal de cada sistema, dividindo o peso do animal pela vantagem mecânica correspondente.","Depois aplique, em cada sistema, o acréscimo de 10% por polia por meio do fator (1 + 0,10 × n).","Compare as duas forças reais obtidas. O sistema mais eficiente será aquele que exigir a menor força de tração."],"debriefing":{"contextoOperacional":"A equipe precisou comparar sistemas de polias para reduzir a força de tração aplicada no içamento de um animal em uma cisterna. O cálculo orientou uma escolha, mas uma operação real exigiria avaliação estrutural, plano de resgate, estabilização do cenário e controle contínuo da carga.","reflexoes":["A Matemática não executa o resgate, mas ajuda a comparar alternativas e justificar decisões técnicas.","Uma solução numericamente eficiente pode ser inadequada se as ancoragens, os equipamentos ou as condições do local não forem compatíveis."],"simplificacoes":["O peso do animal foi tratado como conhecido e constante.","As perdas foram representadas por um acréscimo fixo de 10% por polia.","Foram desprezados atrito variável, elasticidade da corda, oscilações da carga, geometria real do sistema e mudanças durante o içamento."],"matematica":["Razões e proporções","Vantagem mecânica","Porcentagem","Comparação de resultados","Unidades de força"],"interdisciplinaridade":["Matemática e Física na análise de forças.","Engenharia e salvamento terrestre na seleção de equipamentos, ancoragens e sistemas de vantagem mecânica.","Biologia e bem-estar animal no planejamento de uma retirada segura."],"limitesModelo":["A vantagem mecânica real depende do arranjo, do rendimento dos componentes e das condições de uso.","O modelo não dimensiona ancoragens nem substitui procedimentos técnicos de salvamento em altura ou espaço confinado."],"seguranca":["Não entre em cisternas, poços ou espaços confinados para tentar um resgate improvisado.","Isole o local, evite novas quedas e acione o Corpo de Bombeiros pelo telefone 193."],"reflexaoFinal":"Modelar é escolher quais aspectos da realidade serão destacados. Um bom resultado matemático precisa ser interpretado à luz das condições operacionais e dos limites do modelo."},"imagem":"./assets/embedded/aaac68aa00d0a5b7d217.webp"},{"titulo":"🌊 Missão 2: Resgate na Água","contexto":"Uma vítima é arrastada pela correnteza no centro de um rio. Da margem, o bombeiro lançará um saco de arremesso e deverá antecipar o deslocamento da vítima para que ambos se encontrem.","objetivo":"Articular movimento relativo, decomposição de velocidades e lançamento oblíquo para determinar os ângulos de lançamento.","dados":["Largura do rio: 20 m; a vítima está na linha central, a 10 m da margem.","Velocidade da correnteza: V<sub>rio</sub> = 3 m/s.","Velocidade transversal considerada para o saco: V<sub>saco</sub> = 5 m/s.","Velocidade inicial do lançamento oblíquo: v<sub>0</sub> = 25 m/s.","Aceleração da gravidade adotada: g = 10 m/s<sup>2</sup>.","A posição longitudinal da vítima será informada quando a animação for pausada."],"modelo":"Considere o tempo de travessia e a posição futura da vítima. Para o alcance do lançamento, pode-se usar <code>R = (v<sub>0</sub><sup>2</sup> · sen(2α)) ÷ g</code>, associado à distância até o ponto previsto de encontro.","tarefa":"Pause a ocorrência no momento escolhido, analise os dados e determine os ângulos θ e α que permitem que o saco encontre a vítima.","nota":"Os valores adotados compõem um modelo matemático simplificado para fins educacionais e não substituem protocolos operacionais reais.","icone":"🌊","heroLabel":"Missão 2","dicas":["Comece calculando o tempo necessário para o saco atravessar os 10 m que separam a margem da linha central do rio.","Use esse tempo para prever quanto a vítima será deslocada longitudinalmente pela correnteza até o encontro.","Com o ponto futuro da vítima definido, determine a direção horizontal θ e relacione a distância de lançamento à expressão do alcance para encontrar α."],"debriefing":{"contextoOperacional":"O lançamento do saco de resgate foi planejado para encontrar uma vítima que se deslocava com a correnteza. A missão evidenciou que o alvo não permanece na posição observada inicialmente: é necessário antecipar seu movimento.","reflexoes":["Em situações dinâmicas, decidir com base apenas na posição atual pode levar ao erro.","A previsão matemática depende da qualidade das medidas e da estabilidade das condições ambientais."],"simplificacoes":["As velocidades da vítima, da correnteza e do saco foram consideradas constantes.","O rio foi tratado como regular, sem variações de profundidade ou direção.","Foram desprezados turbulência, vento, resistência do ar, obstáculos, fadiga, flutuação e tempo de reação da equipe."],"matematica":["Movimento relativo","Decomposição de velocidades","Trigonometria","Lançamento oblíquo","Distância, tempo e previsão de posição"],"interdisciplinaridade":["Matemática e Física na previsão da trajetória.","Geografia e Ciências Ambientais na leitura da correnteza e do terreno.","Educação Física e salvamento aquático na técnica de lançamento e recuperação."],"limitesModelo":["Correntezas reais variam no espaço e no tempo, e a vítima pode mudar de orientação ou velocidade.","O resultado do jogo não define uma técnica operacional nem garante o alcance em uma situação real."],"seguranca":["Não entre em rios, enchentes ou correntezas para tentar um resgate sem treinamento e equipamentos adequados.","Mantenha-se em local seguro, forneça referências da posição da vítima e ligue 193."],"reflexaoFinal":"A interdisciplinaridade aparece quando conceitos de movimento, ambiente e tomada de decisão precisam ser articulados para compreender um único problema real."},"imagem":"./assets/embedded/e6d940d633b03cc2ad1d.webp"},{"titulo":"❤️ Missão 3: APH — RCP em Shopping Center","contexto":"Uma vítima adulta sofre uma parada cardiorrespiratória em um shopping center. Brigadistas do estabelecimento iniciam imediatamente a RCP e conectam um DEA. Durante o atendimento, a primeira equipe recebe um chamado sobre suspeita de princípio de incêndio em outro setor do shopping e precisa se deslocar para verificar a situação. Para que as manobras não sejam interrompidas, o atendimento da vítima é repassado rapidamente a uma segunda equipe de brigadistas. Na troca, porém, o histórico das seis primeiras análises realizadas pelo DEA não é informado. Pouco depois, sua equipe do Corpo de Bombeiros chega ao local e assume o atendimento já durante o 8º ciclo de RCP.","objetivo":"Executar o 8º período de RCP com atenção à qualidade das compressões e à sequência 30:2, utilizar o DEA e, ao final do atendimento, analisar matematicamente o histórico incompleto da ocorrência.","dados":["Vítima adulta em parada cardiorrespiratória (PCR).","O jogador assume o atendimento no <strong>8º ciclo</strong> de RCP.","Relação adotada no cenário: <strong>30 compressões para 2 ventilações (30:2)</strong>.","Faixa de referência para a frequência das compressões: <strong>100 a 120 compressões/min</strong>.","O resultado conhecido do 7º DEA foi <strong>CHOQUE NÃO INDICADO</strong>.","Os resultados das seis primeiras análises não estão disponíveis para a equipe que assume a ocorrência.","Para esta missão, considere que a indicação clínica para transporte já está presente quando ocorrerem <strong>pelo menos 6 choques indicados</strong>, consecutivos ou não, ou quando o DEA apresentar <strong>3 mensagens consecutivas de “CHOQUE NÃO INDICADO”</strong>.","Após a sequência 30:2, o DEA fará a análise automaticamente."],"modelo":"A primeira parte é uma simulação simplificada do 8º período de RCP. O jogador controla as compressões, acompanha uma estimativa de cadência, realiza duas ventilações e segue as orientações do DEA. Informações matemáticas adicionais serão apresentadas quando se tornarem necessárias no próprio desenvolvimento da ocorrência.","tarefa":"Realize as 30 compressões buscando a faixa de 100–120/min, complete duas ventilações e siga as orientações do DEA. Depois, utilize os dados disponíveis para responder às reflexões matemáticas da equipe.","nota":"A atividade é um modelo educacional simplificado. Não substitui treinamento, certificação, protocolos institucionais ou orientação de profissionais habilitados.","icone":"❤️","heroLabel":"Missão 3 · Ensino Médio","dicas":["Na etapa operacional, procure manter intervalos regulares entre as compressões e acompanhe o monitor de cadência.","Na questão de probabilidade, os seis primeiros resultados desconhecidos geram 2⁶ sequências equiprováveis.","Na questão de garantia, tente construir a maior sequência que ainda evite simultaneamente 6 choques indicados e 3 resultados consecutivos de choque não indicado."],"debriefing":{"contextoOperacional":"A missão representou a continuidade de uma RCP iniciada por brigadistas em um shopping. O CBMMG assumiu a vítima no 8º período, executou a sequência 30:2, seguiu a análise do DEA e precisou adaptar a resposta quando as condições da cena se alteraram.","reflexoes":["A qualidade da RCP depende de vários parâmetros simultâneos; a missão destacou cadência, relação 30:2 e redução de interrupções.","A ausência do histórico das seis primeiras análises transforma a discussão posterior em um problema de informação incompleta.","A primeira reflexão pergunta pela probabilidade de um critério clínico já ter sido alcançado; a segunda pergunta quando isso passa a ser garantido independentemente da sequência."],"simplificacoes":["As seis primeiras análises foram tratadas como resultados independentes e equiprováveis entre choque indicado e choque não indicado.","Cada resultado do DEA foi associado a um período de aproximadamente 2 minutos de RCP.","O simulador representa somente alguns parâmetros de RCP e não reproduz toda a avaliação clínica, logística, comunicação e segurança de uma ocorrência real."],"matematica":["Espaço amostral de 2⁶ sequências equiprováveis para seis resultados desconhecidos.","Probabilidade aproximada de indicação clínica ao final do 8º período: 53,125% no modelo proposto.","Raciocínio combinatório de garantia: 18 é o menor número de resultados que força pelo menos um dos critérios do cenário.","Construção de contraexemplo com 17 resultados para mostrar por que 17 ainda não garante o critério."],"interdisciplinaridade":["Matemática e Atendimento Pré-Hospitalar na leitura de dados produzidos durante uma ocorrência simulada.","Probabilidade e raciocínio combinatório aplicados à tomada de decisão sob informação incompleta.","Segurança da cena e organização operacional como parte do contexto da modelagem."],"limitesModelo":["O desempenho em cliques não mede profundidade real das compressões nem competência em RCP.","O modelo probabilístico equiprobável é uma hipótese didática e não representa distribuição clínica real de ritmos cardíacos.","Os critérios e tempos pertencem ao cenário educacional construído a partir da referência técnica indicada no material da missão."],"seguranca":["RCP e uso do DEA devem seguir treinamento e protocolos aplicáveis; em emergência, acione o serviço competente e siga as orientações recebidas.","A segurança da cena precede a permanência da equipe no local. A simulação não deve ser usada como instrução operacional autônoma."],"reflexaoFinal":"A ocorrência mostra duas funções diferentes da Matemática: estimar a chance de um evento quando faltam informações e demonstrar o momento em que uma condição se torna inevitável. A passagem de 53,125% para a garantia em 18 ciclos evidencia a diferença entre probabilidade e certeza combinatória."},"imagem":"./assets/embedded/missao03_aph_rcp_shopping_briefing.png"},{"titulo":"🌲 Missão 4: Buscas na Mata","contexto":"Uma pessoa desapareceu em área de mata. A equipe parte do último ponto conhecido e executará um padrão quadrado crescente até alcançar a posição da vítima.","objetivo":"Relacionar sequência de comprimentos, coordenadas cartesianas, distância acumulada e tempo de deslocamento.","dados":["Origem da busca: (0, 0).","Posição da vítima: (230, 80).","Velocidade constante da equipe: 0,5 m/s.","Primeiro espaçamento: 10 m.","Os comprimentos dos segmentos seguem 10, 10, 20, 20, 30, 30, ..."],"modelo":"Identifique em qual segmento a posição (230, 80) será atingida. Depois calcule <code>tempo = distância acumulada ÷ velocidade</code>.","tarefa":"Informe em horas e minutos o tempo necessário para que a equipe alcance a vítima seguindo integralmente o protocolo quadrado crescente.","nota":"O simulador considera deslocamento contínuo e velocidade constante durante toda a busca.","icone":"🌲","heroLabel":"Missão 4","dicas":["Organize os deslocamentos por direção e comprimento: 10, 10, 20, 20, 30, 30, e assim sucessivamente.","Atualize as coordenadas ao final de cada segmento até localizar o segmento que contém o ponto (230, 80).","Some todos os segmentos completos anteriores e apenas a parte necessária do último segmento. Depois use tempo = distância ÷ 0,5."],"debriefing":{"contextoOperacional":"A busca foi modelada por um padrão quadrado crescente a partir do último ponto conhecido. O jogador precisou acompanhar coordenadas, comprimentos progressivos e distância acumulada até alcançar a vítima.","reflexoes":["Um padrão de busca organiza o esforço e reduz áreas não verificadas, mas sua eficácia depende da qualidade do ponto inicial e da execução no terreno.","Distância geométrica e distância realmente percorrida podem ser muito diferentes."],"simplificacoes":["O terreno foi tratado como plano, regular e sem obstáculos.","A equipe manteve velocidade constante e direção perfeita.","Foram desprezados relevo, vegetação, cursos d’água, visibilidade, clima, fadiga, erros de navegação e probabilidade de detecção."],"matematica":["Sequências e progressões","Plano cartesiano","Geometria analítica","Distância acumulada","Conversão entre distância, velocidade e tempo"],"interdisciplinaridade":["Matemática e Cartografia na leitura de coordenadas.","Geografia na análise do terreno.","Educação Física, orientação e técnicas de busca no planejamento do deslocamento."],"limitesModelo":["A vítima pode se deslocar, e o último ponto conhecido pode conter incerteza.","A escolha real do padrão depende do ambiente, dos recursos, do comportamento da pessoa perdida e do comando da operação."],"seguranca":["Não realize buscas isoladas em mata sem planejamento, comunicação e orientação adequada.","Ao comunicar um desaparecimento, informe o último local conhecido e acione o Corpo de Bombeiros pelo 193."],"reflexaoFinal":"Sequências e coordenadas ganham significado quando ajudam a descrever um procedimento espacial, mas o modelo precisa reconhecer a incerteza presente no ambiente real."},"imagem":"./assets/embedded/afaa79ea258bda8258e9.webp"},{"titulo":"🔥 Missão 5: Combate ao Incêndio","contexto":"Um galpão apresenta 400 m² de área em chamas. O combate reduz o incêndio, mas, durante os deslocamentos para reabastecimento, o fogo volta a se espalhar.","objetivo":"Modelar a evolução do incêndio por funções lineares por partes e calcular o consumo total de água até a extinção.","dados":["Área inicial do incêndio: 400 m<sup>2</sup>.","Durante o combate, a área diminui 11 m<sup>2</sup> por minuto.","Durante a ausência da equipe, a área aumenta 15 m<sup>2</sup> por minuto.","Vazão de combate: 250 L/min.","Cada carga completa permite 20 minutos de combate, totalizando 5.000 L.","Cada deslocamento para reabastecimento e retorno dura 5 minutos."],"modelo":"Atualize a área ao final de cada fase. No combate: <code>A(t) = A<sub>0</sub> − 11t</code>. Na ausência: <code>A(t) = A<sub>0</sub> + 15t</code>. O consumo é <code>V = 250t</code>.","tarefa":"Determine o volume total de água consumido até que a área em chamas chegue a zero.","nota":"Considere que a última carga pode ser utilizada apenas parcialmente e que não há consumo de água durante o reabastecimento.","icone":"🔥","heroLabel":"Missão 5","dicas":["Calcule a área restante depois dos primeiros 20 minutos de combate usando A = A₀ − 11 × 20.","Durante cada reabastecimento, some à área resultante o crescimento ocorrido em 5 minutos: 15 × 5. Repita esse ciclo enquanto for necessária uma carga completa.","Na última etapa, calcule apenas o tempo necessário para levar a área restante exatamente a zero. O consumo de água é 250 L por minuto apenas durante o combate."],"debriefing":{"contextoOperacional":"A evolução do incêndio foi representada por taxas lineares distintas durante o combate e durante o reabastecimento. O problema exigiu acompanhar a área em chamas e o consumo de água ao longo de fases sucessivas.","reflexoes":["Um incêndio é um fenômeno dinâmico; sua evolução resulta da interação entre combustível, oxigênio, calor, geometria e ações de combate.","Taxas ajudam a compreender tendências, mas não garantem previsões exatas."],"simplificacoes":["A redução e o crescimento da área foram tratados por taxas constantes.","A vazão, a duração do reabastecimento e a eficiência do combate foram consideradas fixas.","Foram desprezados carga de incêndio variável, tipos de materiais, ventilação, colapso estrutural, propagação tridimensional, vento, temperatura e perdas hidráulicas."],"matematica":["Funções lineares por partes","Taxas de variação","Razões e proporções","Sequências de fases","Inequações e unidades de área, tempo e volume"],"interdisciplinaridade":["Matemática na construção do modelo.","Física na análise de calor, vazão e transferência de energia.","Química na combustão e nos materiais.","Engenharia e segurança contra incêndio na avaliação da edificação."],"limitesModelo":["A velocidade de propagação depende dos materiais e de sua carga de incêndio, da ventilação e da geometria do ambiente.","O cálculo didático não determina estratégia, vazão operacional, segurança estrutural ou quantidade real de recursos."],"seguranca":["Em caso de incêndio, abandone o local com segurança, não retorne para buscar objetos e não tente combater chamas desenvolvidas.","Acione o Corpo de Bombeiros pelo 193 e informe endereço, riscos e presença de pessoas."],"reflexaoFinal":"A modelagem permite investigar relações entre tempo, área e recursos, mas decisões reais exigem informações que o modelo deliberadamente não incorporou."},"imagem":"./assets/embedded/9b56d9c7db1c014972a2.webp"},{"titulo":"💧 Missão 6: Busca Aquática em Cachoeira","contexto":"Uma dupla de mergulhadores precisa cobrir integralmente uma área retangular do poço, seguindo faixas paralelas em padrão de zigue-zague.","objetivo":"Relacionar área, largura de varredura, distância percorrida, velocidade e tempo mínimo de busca.","dados":["Área retangular: 80 m × 30 m.","Largura efetiva de cada faixa de varredura: 3 m.","Velocidade média adotada para a equipe: 10 m/min.","O modelo considera a cobertura equivalente área ÷ largura da faixa."],"modelo":"Calcule a distância principal de varredura por <code>d = área ÷ largura da faixa</code> e, em seguida, <code>t = d ÷ velocidade</code>.","tarefa":"Informe o tempo mínimo, em minutos, suficiente para completar toda a varredura.","nota":"Para manter o modelo didático do simulador, o tempo de reposicionamento entre faixas é desprezado.","icone":"💧","heroLabel":"Missão 6","dicas":["Calcule inicialmente a área total do retângulo: 80 × 30.","Divida essa área pela largura efetiva de cada faixa, 3 m, para obter a distância principal de varredura.","Divida a distância pela velocidade de 10 m/min. Neste modelo, não acrescente tempo de reposicionamento entre as faixas."],"debriefing":{"contextoOperacional":"A área de busca subaquática foi dividida em faixas paralelas. A missão relacionou área, largura de cobertura, distância total, velocidade e tempo mínimo de varredura.","reflexoes":["Cobrir sistematicamente uma área exige planejamento para evitar lacunas e repetições.","O tempo calculado representa uma referência ideal, não a duração garantida de uma operação."],"simplificacoes":["A área foi tratada como retangular, plana e totalmente acessível.","A largura de varredura e a velocidade foram consideradas constantes.","Foi desprezado o tempo de mudança entre faixas, além de correnteza, profundidade variável, baixa visibilidade, obstáculos, comunicação e fadiga."],"matematica":["Área de retângulos","Razões e proporções","Cobertura por faixas","Distância, velocidade e tempo","Estimativa operacional"],"interdisciplinaridade":["Matemática e Física no cálculo de cobertura e deslocamento.","Geografia e Ciências Ambientais na leitura do corpo d’água.","Mergulho, Medicina e salvamento aquático na gestão dos riscos humanos."],"limitesModelo":["A largura efetiva de busca depende da visibilidade, da técnica, dos equipamentos e das condições da água.","Operações subaquáticas exigem controle de profundidade, tempo de fundo, gases, comunicação, reserva e suporte de superfície."],"seguranca":["Não mergulhe ou entre em cachoeiras, poços e águas turvas para realizar buscas improvisadas.","Afaste-se de áreas de correnteza e acione o Corpo de Bombeiros pelo telefone 193."],"reflexaoFinal":"A estimativa matemática organiza recursos e expectativas, mas a segurança e a qualidade da varredura dependem de variáveis humanas e ambientais não representadas no cálculo."},"imagem":"./assets/embedded/33de4ba87aade36c4e54.webp"},{"titulo":"🔥 Missão 7: Incêndio Florestal — Construção de Aceiro","contexto":"Um incêndio florestal se desenvolve em uma área de conservação cercada por residências. O foco está em uma região de mata densa e de difícil acesso, impedindo o combate direto. Sua equipe deverá construir uma linha de defesa — um aceiro — antes que a frente do fogo alcance o traçado.","objetivo":"Planejar e testar um aceiro capaz de conter a propagação do incêndio. Depois da primeira contenção, determine uma estratégia circular que reduza ao mínimo possível a área potencialmente queimada.","dados":["O foco inicial é representado por um círculo de <strong>50 m de raio</strong>.","Cada quadrícula da malha representa <strong>100 m × 100 m</strong>.","A frente do incêndio avança radialmente a <strong>2,2 m/min</strong> neste modelo.","A capacidade conjunta das equipes para executar o aceiro é de <strong>17,5 m/min</strong>.","O aceiro somente é considerado eficaz quando estiver <strong>100% concluído</strong>.","O traçado deve permanecer integralmente dentro do <strong>limite operacional seguro</strong> indicado no mapa."],"modelo":"Na primeira fase, experimente aceiros poligonais e compare comprimento, distância até o fogo e tempo de execução. Na segunda fase, use a relação entre o comprimento da circunferência e o avanço do incêndio para determinar o menor raio circular que ainda permita concluir a linha de defesa a tempo.","tarefa":"Fase 1: construa um aceiro poligonal viável. Fase 2: escolha o centro do círculo e determine o menor raio possível para conter o incêndio, podendo defini-lo graficamente ou informar o valor em metros.","nota":"O cenário é um modelo didático: considera propagação circular e uniforme, com vento, relevo, combustível e produtividade das equipes constantes durante o período analisado.","icone":"🔥","heroLabel":"Missão 7 · Ensino Médio","dicas":["Na Fase 1, um aceiro mais distante dá mais tempo para o fogo chegar, mas também costuma exigir um comprimento maior de construção.","Na Fase 2, compare o tempo necessário para construir uma circunferência de raio r com o tempo que o fogo leva para avançar dos 50 m iniciais até esse raio.","Para encontrar o limite da estratégia circular, procure a situação em que os dois tempos ficam praticamente iguais. Depois, considere a precisão solicitada em metros inteiros."],"debriefing":{"contextoOperacional":"A missão representou um incêndio florestal em expansão circular, no qual a equipe precisava concluir uma linha de defesa antes que a frente do fogo alcançasse o traçado. A primeira etapa favoreceu a experimentação com polígonos; a segunda transformou essa experiência em um problema de otimização circular.","reflexoes":["Aumentar a distância entre o fogo e o aceiro aumenta o tempo disponível, mas também pode aumentar o comprimento da linha a ser construída.","Uma estratégia geometricamente válida pode fracassar operacionalmente se a construção não terminar antes da chegada da frente.","Na otimização circular, o centro alinhado ao foco evita criar um ponto desnecessariamente mais próximo do incêndio.","O menor raio útil depende simultaneamente da velocidade de propagação do fogo e da produtividade de construção do aceiro."],"simplificacoes":["A propagação foi considerada circular, uniforme e com velocidade radial constante de 2,2 m/min.","A produtividade conjunta das equipes foi considerada constante em 17,5 m/min.","O foco inicial foi representado por um círculo de raio 50 m e o centro foi mantido fixo.","Não foram modeladas variações de vento, relevo, combustível, fadiga, recursos, segurança das equipes ou mudanças de estratégia durante a execução."],"matematica":["Escala cartográfica e leitura de malha: 1 quadrícula = 100 m.","Perímetro e área de polígonos.","Comprimento e área do círculo: C = 2πr e A = πr².","Taxas de variação e comparação de tempos.","Para o círculo concêntrico: tempo de construção = 2πr / 17,5 e tempo de chegada do fogo = (r − 50) / 2,2.","Igualando os tempos, o limite teórico é r ≈ 237,97 m; portanto, trabalhando em metros inteiros, o menor raio que conclui antes da frente é aproximadamente 238 m.","Para r = 238 m, a área delimitada é aproximadamente 17,8 ha."],"interdisciplinaridade":["Matemática e Geografia na leitura espacial, escala, área e perímetro.","Matemática e Física na comparação entre velocidades e tempos.","Ciências Ambientais e prevenção de incêndios florestais na interpretação dos impactos sobre vegetação e residências."],"limitesModelo":["Incêndios florestais reais não se propagam como círculos perfeitos e podem mudar rapidamente de direção e intensidade.","A produtividade de construção de um aceiro depende do terreno, vegetação, equipamentos, número de equipes e condições de segurança.","O resultado matemático pertence exclusivamente ao modelo educacional desta missão."],"seguranca":["Incêndios florestais exigem atuação especializada, planejamento de rotas de fuga, zonas de segurança e acompanhamento permanente das condições ambientais.","Não tente construir aceiros ou combater incêndios florestais por conta própria. Em uma emergência, afaste-se da área de risco e acione o Corpo de Bombeiros pelo 193."],"reflexaoFinal":"A estratégia ótima surgiu da combinação entre geometria e tempo: não basta construir o menor contorno possível, nem afastar indefinidamente a linha. É necessário encontrar o equilíbrio em que a equipe consegue concluir o aceiro antes da chegada do fogo, preservando a maior área possível da vegetação."},"imagem":"./assets/embedded/7c9df3ab02f975f76c4c.webp"},{"titulo":"🫁 Missão 8: Autonomia de Ar — Busca em Apartamento","contexto":"Uma equipe de bombeiros foi acionada para um incêndio em um apartamento. Uma pessoa foi vista no interior do imóvel antes de a fumaça comprometer completamente a visibilidade. Para realizar a busca, a equipe utilizará equipamento de proteção respiratória com quantidade limitada de ar.","objetivo":"Compreender como o esforço altera o consumo respiratório, calcular a autonomia disponível e programar uma estratégia que permita realizar a maior varredura possível, localizar a vítima e sair com pelo menos 3 minutos de autonomia.","dados":["O padrão respiratório será modelado por funções da forma <strong>V(t)=a+b·sen(ct+d)</strong>.","A relação entre período e frequência angular é <strong>T = 2π/|c|</strong>.","No modelo didático, o volume por ciclo é considerado como <strong>V<sub>máx</sub> − V<sub>mín</sub> = 2A</strong>.","O cilindro utilizado na missão possui <strong>6,8 L</strong> e inicia com <strong>300 bar</strong>.","Para a atividade, use a aproximação <strong>V<sub>ar</sub> ≈ 6,8 · P</strong>.","A estratégia deve garantir uma saída com pelo menos <strong>3 minutos de autonomia</strong>."],"modelo":"A missão é dividida em quatro etapas. Primeiro, modele um padrão respiratório. Depois, interprete três estados de esforço e transforme amplitude e período em consumo de ar. Em seguida, calcule a quantidade de ar do cilindro. Por fim, programe antes da entrada o maior tempo seguro de avanço para a busca.","tarefa":"Determine, por meio dos modelos respiratórios e da autonomia do cilindro, por quanto tempo a equipe pode continuar avançando na busca antes de iniciar o retorno, maximizando a varredura sem comprometer a reserva mínima.","nota":"O volume por ciclo, a relação pressão-volume do cilindro e os valores de alerta usados na missão são simplificações didáticas. A localização atual da vítima e o instante ótimo de retorno não são informados previamente.","icone":"🫁","heroLabel":"Missão 8 · Ensino Médio","dicas":["Para cada senoide, use o período para obter ciclos por minuto e a amplitude para obter o volume por ciclo no modelo didático.","Ao calcular a estratégia, lembre-se de que a equipe precisa consumir ar tanto no avanço quanto no retorno. O retorno ocorre pela mesma rota e com a mesma velocidade do avanço.","Transforme a reserva mínima de 3 minutos em uma quantidade de ar e compare-a com o consumo acumulado ao longo dos diferentes intervalos de esforço. Procure o maior tempo de avanço que ainda preserve essa reserva."],"debriefing":{"contextoOperacional":"A missão representou uma busca em apartamento com visibilidade zero e autonomia limitada de EPR. A equipe precisava definir sua estratégia antes da entrada, utilizando um modelo matemático para o consumo respiratório e para a quantidade de ar disponível.","reflexoes":["A decisão de retorno foi tomada antes da entrada, evitando que a estratégia dependesse apenas da observação da animação.","Os consumos respiratórios foram produzidos a partir da interpretação das senoides, e não fornecidos como dados iniciais.","Uma estratégia conservadora preserva mais ar, mas pode reduzir a área varrida e impedir a localização da vítima.","O maior tempo seguro de avanço é determinado simultaneamente pela autonomia total e pela reserva mínima exigida."],"simplificacoes":["O volume por ciclo foi modelado como Vmáx − Vmín = 2A.","A quantidade equivalente de ar foi aproximada linearmente por V_ar ≈ 6,8P.","O consumo foi considerado constante em cada intervalo de esforço: 40 L/min de 0 a 10 min, 60 L/min de 10 a 20 min e 80 L/min após 20 min.","O avanço e o retorno foram considerados com a mesma velocidade sobre uma rota fixa e previamente calibrada."],"matematica":["Função seno e transformações: V(t)=a+b·sen(ct+d).","Período de uma senoide: T=2π/|c|.","Baixo esforço: amplitude 1 L, período 3 s, 20 ciclos/min, volume/ciclo 2 L e consumo 40 L/min.","Esforço moderado: amplitude 1,25 L, período 2,5 s, 24 ciclos/min, volume/ciclo 2,5 L e consumo 60 L/min.","Esforço intenso: amplitude 4/3 L, período 2 s, 30 ciclos/min, volume/ciclo ≈2,67 L e consumo 80 L/min.","Cilindro: 6,8 L × 300 bar ≈ 2.040 L equivalentes de ar.","A autonomia total do modelo é 33 min: 400 L nos primeiros 10 min, 600 L nos 10 min seguintes e 1.040 L nos 13 min finais.","A reserva mínima de 3 min no estado intenso corresponde a 240 L, aproximadamente 35,3 bar.","O maior tempo seguro de avanço é 15 min. O retorno termina aos 30 min, com 240 L restantes e exatamente 3 min de autonomia."],"interdisciplinaridade":["Matemática e Física na interpretação de periodicidade, taxas de consumo, pressão e volume.","Matemática e Ciências na modelagem de padrões respiratórios e esforço.","Segurança operacional na necessidade de planejamento prévio e preservação de reserva de ar."],"limitesModelo":["O comportamento respiratório real varia entre indivíduos, tarefas, estresse, temperatura e equipamentos.","A relação entre pressão e volume disponível foi simplificada para fins escolares.","O alerta de 75 bar é um parâmetro didático desta experiência e não representa uma regra operacional universal.","A geometria da planta e da rota é fixa para manter a calibração matemática do simulador."],"seguranca":["Ambientes incendiados e tomados por fumaça são extremamente perigosos e só devem ser acessados por equipes treinadas, equipadas e inseridas em uma estrutura operacional de segurança.","Em caso de incêndio, abandone a área de risco e acione o Corpo de Bombeiros pelo 193."],"reflexaoFinal":"A estratégia de 15 minutos não foi fornecida pelo cenário: ela surgiu ao encadear função seno, período, frequência respiratória, volume por ciclo, consumo de ar e autonomia. A matemática determinou o limite entre ampliar a busca e preservar a reserva necessária para retornar em segurança."},"imagem":"./assets/embedded/5dd72a37cd481b3e47e9.webp"},{"titulo":"🚤 Missão 9: Travessia Estratégica na Represa","contexto":"Durante uma ação de prevenção aquática em uma represa, uma pessoa sofre um mal súbito e desmaia na margem oposta. Duas pessoas próximas à vítima chamam os bombeiros, que já estão posicionados na base de prevenção aquática. A dupla precisa chegar até a vítima no menor tempo possível.","objetivo":"Escolher o ponto de desembarque D que minimize o tempo total de resposta, equilibrando a travessia mais lenta de bote e a corrida mais rápida pela margem. Depois, justificar matematicamente por que a estratégia encontrada é realmente ótima.","dados":["O ponto <strong>C</strong> está diretamente em frente à base <strong>A</strong>, a <strong>400 m</strong> de distância.","A vítima está no ponto <strong>B</strong>, situado <strong>800 m</strong> adiante de C ao longo da margem.","O bote se desloca a <strong>6 km/h</strong>.","A equipe corre em terra a <strong>10 km/h</strong>.","O ponto <strong>D</strong> pode ser escolhido em qualquer posição entre C e B; a variável <strong>x = CD</strong> varia de 0 a 800 m."],"modelo":"Você pode começar pela experimentação no simulador ou ir diretamente para a modelagem. No modelo, AD é a hipotenusa de um triângulo retângulo, DB é a distância restante pela margem e o tempo total resulta da soma dos tempos nos dois meios de deslocamento.","tarefa":"Determine o ponto de desembarque que produz o menor tempo total. Encontrar uma boa estratégia experimental é apenas uma conjectura: para concluir a missão, apresente também uma justificativa matemática exata, sem necessidade de derivadas.","nota":"A represa é tratada como sem correnteza relevante; as velocidades são constantes; o bote segue de A a D em linha reta; o trecho terrestre é modelado pela distância restante ao longo da margem. O pedido de socorro é presencial, feito pelas pessoas na margem oposta — não há ligação ao 193 nem deslocamento de viatura nesta ocorrência.","icone":"🚤","heroLabel":"Missão 9 · Ensino Médio","dicas":["Experimente pontos extremos e intermediários. Remar menos reduz o trecho lento na água, mas aumenta a corrida; remar mais faz o contrário.","Se x representar CD em quilômetros, use Pitágoras para escrever AD e lembre que DB = 0,8 − x.","Para justificar o mínimo sem derivadas, você pode provar que o tempo nunca é menor que 8 minutos ou procurar diretamente a condição de mínimo usando r = AD e a relação 3–4–5."],"debriefing":{"contextoOperacional":"A missão representou uma resposta a um mal súbito na margem oposta de uma represa. A equipe precisava escolher onde desembarcar o bote para equilibrar uma travessia aquática mais lenta e uma corrida terrestre mais rápida.","reflexoes":["As estratégias intuitivas extremas não são ótimas: atravessar perpendicularmente gera muita corrida, enquanto remar diretamente até a vítima aumenta demais o trecho mais lento.","O simulador produz evidências e permite formular uma conjectura, mas testar pontos não prova o mínimo em uma variável contínua.","A modelagem transforma a decisão operacional em uma função de tempo e permite justificar rigorosamente o ponto ótimo.","A mesma solução pode ser alcançada por caminhos diferentes: experimentação seguida de prova ou resolução analítica direta."],"simplificacoes":["As velocidades foram consideradas constantes: 6 km/h no bote e 10 km/h em terra.","A correnteza foi desprezada, compatível com o cenário didático de represa.","O bote foi modelado em trajetória retilínea de A até D e o trecho terrestre como 800 − x metros.","Tempos de embarque, desembarque e início do atendimento foram desprezados ou considerados iguais entre estratégias."],"matematica":["Com x = CD em quilômetros, AD = √(x² + 0,16) e DB = 0,8 − x.","Tempo em horas: T(x) = √(x² + 0,16)/6 + (0,8 − x)/10.","Tempo em minutos: T(x) = 10√(x² + 0,16) + 6(0,8 − x).","Pela prova do menor tempo: T(x) ≥ 8 min equivale a uma desigualdade que conduz a 4(10x − 3)² ≥ 0; a igualdade ocorre somente em x = 0,3 km.","Pela solução direta, com r = AD, minimizar T equivale a minimizar 5r − 3x. A identidade (5r − 3x)² = 16(r² − x²) + (3r − 5x)² leva à condição 3r = 5x.","Como r² − x² = 0,16, surge a proporção 3–4–5: x = 0,3 km, AC = 0,4 km e AD = 0,5 km.","Resultado exato: desembarque 300 m após C, 500 m de bote, 500 m de corrida e tempo total mínimo de 8 minutos."],"interdisciplinaridade":["Matemática e Física na relação distância, velocidade e tempo.","Geometria e Teorema de Pitágoras na determinação do trecho aquático.","Modelagem matemática e argumentação na distinção entre conjectura experimental e demonstração exata."],"limitesModelo":["Velocidades reais dependem de vento, condição da água, terreno, fadiga, embarcação e condição da equipe.","A margem real não é perfeitamente retilínea e o acesso terrestre pode apresentar obstáculos.","O resultado de 300 m e 8 minutos pertence ao modelo didático calibrado para esta missão."],"seguranca":["Operações aquáticas exigem equipes treinadas, equipamentos apropriados e avaliação das condições do ambiente.","Em emergências reais, siga as orientações das autoridades e acione o Corpo de Bombeiros pelo 193 quando necessário."],"reflexaoFinal":"A melhor decisão não surgiu de escolher o menor caminho em um único meio, mas de equilibrar dois deslocamentos com velocidades diferentes. A experimentação sugeriu a resposta; a álgebra mostrou por que 300 m após C é exatamente o ponto ótimo."},"imagem":"./assets/embedded/dd9ace2de5cd2982dadf.png"},{"titulo":"🚒 Missão 10: Posicionamento da Plataforma e Projeção do Jato","contexto":"Um incêndio atingiu a parte superior da fachada de uma edificação residencial. Para realizar o combate externo e o resfriamento da área, sua equipe posicionou a plataforma elevatória no pátio do condomínio. O chefe da guarnição determinou que o braço fosse ajustado para 17 metros de extensão e inclinação de 45° em relação à horizontal. A articulação do equipamento está a 2 metros do solo e a 24 metros da fachada. Determine as coordenadas da caçamba, posicione corretamente a plataforma e calcule a altura em que o jato atinge a fachada.","objetivo":"Determinar as coordenadas corretas da caçamba e calcular a altura, em relação ao solo, em que o jato de água atinge a fachada do prédio.","dados":["A articulação do braço está a <strong>2 m do solo</strong> e a <strong>24 m da fachada</strong>.","A configuração operacional determinada para a plataforma é <strong>17 m de extensão</strong> e <strong>45° de inclinação</strong> em relação à horizontal.","No sistema cartesiano principal da missão, a origem <strong>(0,0)</strong> está na articulação do braço; <strong>x</strong> cresce em direção à fachada e <strong>y</strong> cresce para cima.","Em um ensaio realizado em campo aberto, tomando a saída do esguicho como referência, observou-se que, após avançar <strong>6 m horizontalmente</strong>, o jato estava <strong>3 m acima</strong> da saída.","No mesmo ensaio, após avançar <strong>18 m horizontalmente</strong>, o jato encontrava-se novamente <strong>3 m acima</strong> da saída.","Considere que a trajetória do jato pode ser modelada por uma função quadrática da forma <strong>f(x)=ax²+bx+c</strong>, em que <strong>x</strong> mede o avanço horizontal a partir da saída do esguicho e <strong>f(x)</strong> representa a elevação do jato em relação a essa saída.","A posição inicial do simulador é <strong>8 m</strong> e <strong>20°</strong>, com o jato desligado.","Quando a plataforma estiver na posição correta e o jato estiver ligado, a configuração será estabilizada. A partir desse momento, o combate visual continuará enquanto você calcula a altura de impacto."],"modelo":"Primeiro, use trigonometria para decompor o braço de 17 m nas componentes horizontal e vertical e localizar a caçamba. Depois de estabilizar a plataforma e observar o jato, utilize os dados do ensaio do canhão para calcular a altura de impacto na fachada. Você pode escolher o sistema de referência matemático que considerar mais conveniente; o resultado físico procurado é a altura em relação ao solo.","tarefa":"Explore o simulador, posicione a plataforma na configuração determinada pelo chefe da guarnição e ligue o jato. Quando a posição operacional for confirmada, a plataforma e o jato serão estabilizados. Calcule então a altura em que a água atinge a fachada para concluir a ocorrência.","nota":"Os valores de alcance, tempos visuais de combate e dados do ensaio foram definidos para fins didáticos desta modelagem. Eles não substituem parâmetros operacionais reais de uma plataforma elevatória ou de um canhão monitor.","icone":"🚒","heroLabel":"Missão 10 · Ensino Médio","dicas":["Use <strong>x = 17·cos 45°</strong> e <strong>y = 17·sen 45°</strong>. Como <strong>cos 45° = sen 45° = √2/2</strong>, as duas componentes serão aproximadamente iguais.","Depois de posicionar a caçamba, calcule a altura da saída do esguicho em relação ao solo somando a altura da articulação com a componente vertical do braço. A distância horizontal restante até a fachada também deve ser recalculada a partir dessa nova posição.","Para modelar o jato, escolha um referencial conveniente. Se tomar a própria saída do esguicho como origem, os dados do ensaio fornecem as condições <strong>f(0)=0</strong>, <strong>f(6)=3</strong> e <strong>f(18)=3</strong>. O valor procurado, porém, é a <strong>altura final em relação ao solo</strong>."],"debriefing":{"contextoOperacional":"A missão representou um combate externo a incêndio em fachada por meio de uma plataforma elevatória equipada com canhão monitor. O desafio consistiu em posicionar corretamente o braço, interpretar um modelo parabólico para a água e relacionar medidas relativas e absolutas durante a atuação.","reflexoes":["A posição correta da caçamba não foi fornecida diretamente: foi necessário transformar extensão e inclinação em coordenadas cartesianas por meio de seno e cosseno.","A expressão algébrica usada para representar a trajetória depende da escolha do sistema de coordenadas. Diferentes referenciais podem produzir coeficientes diferentes para a mesma trajetória física.","Independentemente do referencial escolhido, a altura física em que o jato atinge a fachada é a mesma: 18 m em relação ao solo.","A missão diferenciou grandezas relativas a um ponto de referência da altura absoluta medida a partir do solo."],"simplificacoes":["A cena foi representada em um único plano lateral, mantendo plataforma, fachada e trajetória da água no mesmo enquadramento.","A caçamba permanece horizontal em todas as posições, acompanhando apenas a extremidade do braço.","O jato foi modelado por uma parábola fixa e idealizada, determinada por três condições didáticas.","A redução das chamas e da fumaça foi simplificada por progressões visuais dependentes do tempo de aplicação efetiva do jato."],"matematica":["Trigonometria no triângulo retângulo: x = 17 cos 45° e y = 17 sen 45°.","Coordenadas aproximadas da caçamba: (12,0 ; 12,0).","Altura da saída do esguicho: 2 + 12 = 14 m.","Distância horizontal restante até a fachada: 24 − 12 = 12 m.","Se a origem local for colocada na saída do esguicho, uma representação possível é f(u) = -u²/36 + 2u/3; nesse referencial, f(12)=4 m representa a elevação do jato em relação à saída.","Se o eixo horizontal for mantido com origem na articulação e a altura for medida em relação ao solo, uma representação equivalente na configuração final é h(X) = -X²/36 + 4X/3 + 2.","As expressões têm coeficientes diferentes porque usam referenciais diferentes, mas ambas descrevem a mesma trajetória física.","Altura final de impacto na fachada: 14 + 4 = 18 m."],"interdisciplinaridade":["Matemática aplicada ao posicionamento de equipamento operacional do Corpo de Bombeiros.","Física e modelagem na interpretação de trajetória, ângulo e alcance do jato.","Tomada de decisão operacional associada à leitura de medidas, coordenadas e representação gráfica."],"limitesModelo":["A trajetória real de um jato d’água depende de vazão, pressão, vento, regulagem do esguicho e outras variáveis não representadas integralmente no simulador.","O simulador não substitui treinamento operacional nem parâmetros técnicos de uso real de plataforma elevatória.","A coincidência entre o ponto matemático de impacto e a região das chamas foi calibrada visualmente para fins educacionais."],"seguranca":["Ocorrências com incêndio em edificação exigem equipes treinadas, equipamentos adequados e avaliação contínua dos riscos da cena.","Em emergências reais, afaste-se da área de risco e acione o Corpo de Bombeiros pelo 193."],"reflexaoFinal":"A missão mostra que uma mesma trajetória física pode ser representada por expressões algébricas diferentes quando o sistema de coordenadas muda. O resultado operacional, porém, permanece invariável: depois de posicionar corretamente a plataforma, a matemática permite determinar que o jato atinge a fachada a 18 m do solo."},"imagem":"./assets/embedded/missao10_posicionamento_plataforma_briefing.png"},{"titulo":"🔥 Missão 11: Pressão no esguicho","contexto":"Um incêndio atinge o pavimento superior de um edifício comercial. A equipe de ataque já alcançou o local, mas a água precisa percorrer toda a linha de mangueira e vencer a elevação até o esguicho. Como operador da viatura, sua tarefa é calcular e aplicar no corpo de bomba a pressão necessária para que a dupla de combate receba um jato adequado.","objetivo":"Interpretar as cotas da cena, calcular o comprimento total da linha e o desnível, determinar as perdas de pressão e ajustar corretamente a pressão no corpo de bomba.","dados":["O esguicho precisa receber <strong>5,0 bar</strong>.","A perda por comprimento é de <strong>0,05 bar por metro de linha</strong>.","A perda por elevação é de <strong>0,10 bar por metro de coluna d’água</strong>.","Cada lance de escada possui projeções de <strong>2,0 m na horizontal</strong> e <strong>1,5 m na vertical</strong>.","A linha vence <strong>4 pavimentos</strong>, com dois lances de escada por pavimento.","As demais medidas necessárias estão indicadas diretamente pelas cotas do simulador."],"modelo":"Use o teorema de Pitágoras para calcular os trechos diagonais. Depois, determine separadamente a perda causada pelo comprimento total da mangueira e a perda causada pela elevação. Nesta missão, considere <strong>P<sub>bomba</sub> = P<sub>esguicho</sub> + perdas</strong>.","tarefa":"Calcule a pressão necessária no corpo de bomba, insira o valor no painel, pressurize a linha e abra o esguicho. Observe se o jato alcança corretamente o foco do incêndio.","nota":"Os coeficientes de perda são dados operacionais simplificados desta missão. Em operações reais, a perda de carga também depende da vazão, do diâmetro, do material e da configuração da linha, dos acessórios, do esguicho e das características do equipamento.","icone":"🔥","heroLabel":"Missão 11 · Ensino Médio","dicas":["Em cada lance de escada, aplique Pitágoras aos catetos de 2,0 m e 1,5 m.","Some todos os trechos da linha. O comprimento total encontrado deve ser 36,0 m e o desnível, 12,0 m.","Calcule 0,05 × 36 e 0,10 × 12. Some essas perdas aos 5,0 bar necessários no esguicho."],"debriefing":{"contextoOperacional":"A missão representou o trabalho do operador da bomba durante o combate a um incêndio em pavimento elevado. A pressão aplicada na viatura precisou compensar as perdas ao longo da mangueira e o desnível até a dupla de ataque.","reflexoes":["A pressão indicada no corpo de bomba não é a mesma que chega ao esguicho.","Comprimento e elevação produzem perdas distintas e devem ser calculados separadamente.","Uma pressão insuficiente reduz o alcance do jato; uma pressão excessiva também pode comprometer o ponto de impacto previsto."],"simplificacoes":["Cada lance de escada foi modelado como a hipotenusa de um triângulo retângulo de catetos 2,0 m e 1,5 m.","O comprimento total da linha foi considerado igual a 36,0 m e o desnível positivo igual a 12,0 m.","As perdas foram representadas por coeficientes lineares e absolutos."],"matematica":["Teorema de Pitágoras","Decomposição de percursos em trechos","Grandezas e unidades de medida","Expressões algébricas e modelagem linear","Validação de resultados em uma situação aplicada"],"interdisciplinaridade":["Matemática e hidráulica aplicada ao combate a incêndio.","Geometria espacial na leitura do percurso da mangueira.","Tomada de decisão operacional baseada em cálculos."],"limitesModelo":["O simulador não reproduz toda a dinâmica hidráulica de uma linha real.","Não foram modeladas variações de vazão, diâmetro, rugosidade, acessórios ou características específicas do esguicho.","Os coeficientes apresentados pertencem exclusivamente ao modelo didático da missão."],"seguranca":["A operação de bombas e linhas pressurizadas deve ser realizada por profissionais capacitados.","Em ocorrências reais, devem ser observados os procedimentos operacionais, a comunicação entre as equipes e os limites dos equipamentos.","Os valores do simulador não substituem cálculos, tabelas ou orientações técnicas institucionais."],"reflexaoFinal":"A linha possui 36,0 m e vence 12,0 m de altura. As perdas são 1,8 bar no comprimento e 1,2 bar na elevação, totalizando 3,0 bar. Portanto, para entregar 5,0 bar no esguicho, a bomba deve ser ajustada para 8,0 bar."},"imagem":"./assets/embedded/missao11_pressao_esguicho_briefing.png"},null,null,null]};
...
const AUDIO_B64 = {"menu":"./assets/audio/menu-18f7c758f7.mp3","promocao":"./assets/audio/promocao-afa04d99c4.mp3","musica_0":"./assets/audio/musica_0-21c4c559bb.mp3","musica_1":"./assets/audio/musica_1-ad1dfe6586.mp3","musica_2":"./assets/audio/musica_2-cdb963151b.mp3","musica_3":"./assets/audio/musica_3-8d54dae833.mp3","musica_4":"./assets/audio/musica_4-449b848576.mp3","musica_5":"./assets/audio/musica_5-f5fc8b46ec.mp3","chamada_0":"./assets/audio/chamada_0-889b974a0a.mp3","chamada_1":"./assets/audio/chamada_1-1299c56005.mp3","chamada_2":"./assets/audio/chamada_2-d2a2e66a16.mp3","chamada_3":"./assets/audio/chamada_3-f8d72fdc83.mp3","chamada_4":"./assets/audio/chamada_4-c6d59dd1b8.mp3","chamada_5":"./assets/audio/chamada_5-34ffef6bff.mp3","musica_2_2":"./assets/audio/musica_missao03_aph_rcp_shopping.mp3","chamada_2_2":"./assets/audio/chamada_missao03_aph_rcp_shopping.mp3","chamada_2_9":"./assets/audio/chamada_missao10_posicionamento_plataforma.mp3","musica_2_9":"./assets/audio/musica_missao10_posicionamento_plataforma.mp3","chamada_2_10":"./assets/audio/chamada_missao11_pressao_esguicho.mp3","musica_2_10":"./assets/audio/musica_missao11_pressao_esguicho.mp3"};
let nomeJogador="";
let nivelAtual=null;
...
function obterAudioMissao(id){
  const chave=chaveAudioMissao('musica',id);
  return CACHE_AUDIO_MISSAO.get(chave) || precarregarAudioMissao(id) || null;
}

function retomarMusicaMissao(id) {
  if(audioEstaMutado())return false;
  const audio=obterAudioMissao(id);
  if(!audio)return false;
  if(audioMissaoAtual&&audioMissaoAtual!==audio)pararAudioObj(audioMissaoAtual);
  audioMissaoAtual=audio;
...
function tocarMusicaMissao(id) {
  const audio=obterAudioMissao(id);
  if(!audio||audioEstaMutado()){
    if(audioEstaMutado())audioMissaoAtual=null;
    return false;
  }
  if(audioMissaoAtual&&audioMissaoAtual!==audio)pararAudioObj(audioMissaoAtual);
  audioMissaoAtual=audio;
  try{audioMissaoAtual.currentTime=0;}catch(_erro){}
  return retomarMusicaMissao(id);
}

function pausarMusicaMissao(){
  if(!audioMissaoAtual)return;
  try{audioMissaoAtual.pause();}catch(_erro){}
}
...
function sincronizarAudioGlobalComSimuladores(){
  const mutado=audioEstaMutado();
  document.querySelectorAll('.mission-frame').forEach(frame=>{
    try{frame.contentWindow?.postMessage({type:'audio-state-sync',muted:mutado},'*');}catch(_erro){}
  });
}
...
function retomarAudioDoContextoAtual(){
  ...
  if(elementoEstaVisivel(document.getElementById('tela-missao'))&&missaoAtual!==null){
    ...
    if(!MISSOES?.[missaoAtual]?.resolvida&&!estado?.successDetected){
      if(MISSOES?.[missaoAtual]?.trilhaSincronizadaSimulacao){
        const frame=document.getElementById(`missionFrame-${nivelAtual}-${missaoAtual}`);
        if(frame?.dataset.simulationAudio==='running')retomarMusicaMissao(missaoAtual);
      }else{
        tocarMusicaMissao(missaoAtual);
      }
    }
    return;
  }
...
function definirAudioGlobalMutado(mutado,{persistir=true,retomar=true}={}){
  ...
  if(audioGlobalMutado===novo){
    ...
    sincronizarVideoAberturaComAudio();
    sincronizarAudioGlobalComSimuladores();
    return novo;
  }
...
function sincronizarEstadoComSimulador(frame,id,e){
  ...
  try{
    frame.contentWindow.postMessage({
      ...
      audioMuted:typeof audioEstaMutado==='function'?audioEstaMutado():false
    },'*');
  }catch(_){ }
}
...
window.addEventListener('message',(ev)=>{
  ...
  const mensagemAudio=data.type==='simulation-audio';
  if(mensagemAudio){
    if(!MISSOES[id]?.trilhaSincronizadaSimulacao)return;
    const acao=String(data.action||'').toLowerCase();
    if(acao==='start'||acao==='resume'){
      frame.dataset.simulationAudio='running';
      if(id===missaoAtual)retomarMusicaMissao(id);
    }else if(acao==='restart'){
      frame.dataset.simulationAudio='running';
      if(id===missaoAtual)tocarMusicaMissao(id);
    }else if(acao==='pause'){
      frame.dataset.simulationAudio='paused';
      if(id===missaoAtual)pausarMusicaMissao();
    }else if(acao==='stop'){
      frame.dataset.simulationAudio='stopped';
      if(id===missaoAtual)pararMusicaMissao();
    }
    return;
  }
...
Object.assign(AUDIO_B64, {"chamada_1_0":"./assets/audio/chamada_1_0-eb7693ba4a.mp3","musica_1_0":"./assets/audio/musica_1_0-e38971e266.mp3","chamada_1_1":"./assets/audio/chamada_1_1-2d1f51d1dc.mp3","musica_1_1":"./assets/audio/musica_1_1-6d73942ca2.mp3","chamada_2_6":"./assets/audio/chamada_2_6-5c35d1b8e6.mp3","musica_2_6":"./assets/audio/musica_2_6-d791626c1b.mp3","chamada_2_7":"./assets/audio/chamada_2_7-5f51b1e663.mp3","musica_2_7":"./assets/audio/musica_2_7-e0b989e388.mp3","chamada_2_8":"./assets/audio/chamada_2_8-0d6df4099e.mp3","musica_2_8":"./assets/audio/musica_2_8-3e13223367.mp3"});
...
/* =========================================================
   ...
   ========================================================= */
const ABERTURA_SESSION_KEY='operacao-salvamento:fase35:abertura-exibida';
...
function renderizarVisualOcorrencia(elemento,missao){
  ...
  // Slots ainda não implementados nas versões anteriores nascem com a classe
  // `pendente`. Ao receber uma missão pronta, removemos esse estado para que
  // ela herde os mesmos efeitos de hover, seleção e destaque das demais.
  elemento.classList.remove('pendente');
...
function iniciarSelecaoMissao(id){
  ...
  pararMenuMusica();
  const fluxoOcorrencia=MISSOES[id]?.fluxoOcorrencia||'despacho-viatura';
  if(fluxoOcorrencia==='pedido-presencial'){
    if(typeof audioEstaMutado==='function'&&audioEstaMutado())mostrarToast('toast-mapa','👋 Pedido de socorro recebido — áudio desativado.');
    tocarChamada(id,()=>{animando=false;abrirBriefing(id);});
    return;
  }
...
function moverCaminhaoPara(id){
  ...
  const anguloTrajeto=Math.atan2(deltaY,deltaX)*180/Math.PI;
  // O SVG-base da viatura aponta para a direita. Para destinos no semiplano
  // esquerdo, espelhamos horizontalmente e compensamos 180 graus. Assim a
  // cabine continua apontando para a ocorrência sem a viatura ficar de cabeça
  // para baixo. A regra é geométrica e independe do número/slot da missão.
  const destinoAEsquerda=deltaX<0;
  const anguloVisual=destinoAEsquerda
    ? anguloTrajeto+(anguloTrajeto>0?-180:180)
    : anguloTrajeto;
  const espelhoX=destinoAEsquerda?-1:1;
  caminhao.style.transition='none';
  caminhao.style.left=`${inicioX}px`;
  caminhao.style.top=`${inicioY}px`;
  caminhao.style.transform=`translate(-50%,-50%) rotate(${anguloVisual}deg) scaleX(${espelhoX})`;
...
const PEDAGOGICAL_MISSIONS_POR_NIVEL=Object.freeze({
  fundamental:Object.freeze({
    ...
    3:Object.freeze({name:'Galeria Subterrânea',content:'Redes, contagem de conexões, paridade e caminho euleriano',knowledge:'Contagem, números pares e ímpares, organização de redes e raciocínio lógico',objective:'Resolver inicialmente um problema de percurso por investigação, comparar todas as soluções e reconhecer o padrão que será formalizado no debriefing.',duration:'15–25 min',complexity:'Intermediária',interdisciplinary:'Matemática, lógica e planejamento operacional',use:'Investigação matemática: tentativa, comparação de soluções, identificação de regularidades e posterior formalização do caminho euleriano.'})
  }),
  'ensino-medio':Object.freeze({
    ...
    3:Object.freeze({name:'APH — RCP em Shopping Center',content:'Probabilidade, espaço amostral e garantia combinatória',knowledge:'Probabilidade, contagem de sequências, raciocínio combinatório e interpretação de condições',objective:'Analisar um histórico incompleto de resultados do DEA e distinguir uma conclusão probabilística de uma garantia válida para qualquer sequência.',duration:'20–30 min',complexity:'Avançada',interdisciplinary:'Matemática e Atendimento Pré-Hospitalar',use:'Aplicação de probabilidade e raciocínio combinatório em situação operacional contextualizada.'}),
    ...
    11:Object.freeze({name:'Pressão no esguicho',content:'Geometria, teorema de Pitágoras e modelagem linear de perdas de pressão',knowledge:'Triângulos retângulos, medidas, operações com decimais, expressões algébricas e análise de unidades',objective:'Calcular o comprimento da linha e o desnível para determinar a pressão que deve ser aplicada na bomba e garantir 5 bar no esguicho.',duration:'20–30 min',complexity:'Avançada',interdisciplinary:'Matemática, hidráulica e combate a incêndio',use:'Modelagem matemática de uma situação operacional com validação visual do resultado.'})
  })
});
...
function obterOuCriarFrame(id){
  ...
  if(!frame){
    ...
    frame.addEventListener('load',()=>{
      ...
      try{frame.contentWindow?.postMessage({type:'audio-state-sync',muted:typeof audioEstaMutado==='function'?audioEstaMutado():false},'*');}catch(_erro){}
...
function pausarSimulacaoNoFrame(id){
  if(id===null||id===undefined)return;
  const frame=document.getElementById(`missionFrame-${nivelAtual}-${id}`);
  if(!frame?.contentWindow)return;
  try{frame.contentWindow.postMessage({type:'simulation-control',action:'pause',missionId:id},'*');}catch(_erro){}
}
function abrirMissao(id){
  ...
  const frame=mostrarFrameMissao(id);
  try{frame.contentWindow?.postMessage({type:'simulation-control',action:'resume',missionId:id},'*');}catch(_erro){}
  ...
  if(!MISSOES[id].resolvida&&!e.successDetected){
    if(MISSOES[id].trilhaSincronizadaSimulacao){
      try{precarregarAudioMissao(id);}catch(_erro){}
      // Fase 35.1: algumas missões usam a trilha como ambientação da própria tela do
      // simulador. Nesses casos ela começa ao entrar no simulador, sem aguardar o
      // botão Iniciar; os eventos Pausar/Continuar continuam sincronizando a trilha.
      if(MISSOES[id].trilhaIniciaAoAbrirSimulador){
        frame.dataset.simulationAudio='running';
        tocarMusicaMissao(id);
      }
    }else{
      tocarMusicaMissao(id);
    }
...
function executarReinicioSimulador(id){
  ...
  pararMusicaMissao();
  const frame=obterOuCriarFrame(id); frame.dataset.simulationAudio='stopped';e.simulatorReportedAttempts=0;e.simulatorLoaded=false;frame.dataset.loaded='false';mostrarCarregamentoSimulador(true);
